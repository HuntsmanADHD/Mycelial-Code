...
# ================================================================`;
  ...
  generateStringFunctions() {
    ...
    lines.push(`    push r15`);
    lines.push(``);
    lines.push(`    # Save arguments`);
    lines.push(`    mov r12, rdi              # r12 = format string`);
    lines.push(`    push rsi                  # arg1`);
    lines.push(`    push rdx                  # arg2`);
    lines.push(`    push rcx                  # arg3`);
    lines.push(`    push r8                   # arg4`);
    lines.push(`    push r9                   # arg5`);
    lines.push(``);
    ...
    lines.push(``);
    lines.push(`    # Get argument from stack (reverse order)`);
    lines.push(`    push rcx`);
    lines.push(`    mov rcx, 4`);
    lines.push(`    sub rcx, rbx`);
    lines.push(`    imul rcx, 8`);
    lines.push(`    mov rax, [rsp + rcx + 8]  # Get arg from stack (+8 for pushed rcx)`);
    lines.push(`    pop rcx`);
    lines.push(``);
    ...
    lines.push(`    add rsp, 40               # Pop 5 arguments`);
    lines.push(``);
    lines.push(`    pop r15`);
    lines.push(`    pop r14`);
    lines.push(`    pop r13`);
